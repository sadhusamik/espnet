...
from espnet2.modnet_v3.projector.projector import LinearProjector
from espnet2.modnet_v3.espnet_model import ModNet_v3
...
class ModnetTask_v3(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ModNet_v3),
    ...
    @classmethod
    def build_model(cls, args: argparse.Namespace) -> ModNet_v3:
        assert check_argument_types()
